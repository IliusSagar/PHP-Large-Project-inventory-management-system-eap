...
<div class="auth-wrapper">
			...
			<div class="row align-items-center">
				<div class="col-md-6">
					<div class="card-body">
						...
						<br>
						<button name="button1" class="btn btn-primary mb-4">Login</button>
						</form>
						...
						if (isset($_POST["button1"]))
						{
							...
							$count=0;
							$res=mysqli_query($link,"select * from user_registration where email='$email' && password='$password' && role='user' && status='active'");
 ...
 -->					</div>
				...
				<div class="col-md-6 d-none d-md-block">
					<img src="https://images.pexels.com/photos/1229861/pexels-photo-1229861.jpeg?cs=srgb&dl=pexels-hasan-albari-1229861.jpg&fm=jpg" alt="" class="img-fluid">
				</div>
			</div>
		</div>
	</div>
