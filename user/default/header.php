		...
		<div class="navbar-wrapper ">
			...
			<div class="navbar-content scroll-div">
				<ul class="nav pcoded-inner-navbar">
					...
					<li class="nav-item" id="sa-hover">
						<a href="index.html" class="nav-link hover-"><span class="pcoded-micon"><i id="sa-color" class="feather icon-home"></i></span><span class="pcoded-mtext" id="sa-color">Dashboard</span></a>
					</li>
					<li class="nav-item pcoded-menu-caption">
