...
$("body").append('<div class="fixed-button active"><a href="https://eapsoftware.xyz/" target="_blank" class="btn btn-md btn-primary"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Upgrade To EAP Soft</a> </div>');var $window=$(window),nav=$(".fixed-button");