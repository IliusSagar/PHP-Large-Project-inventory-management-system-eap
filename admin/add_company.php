									...
									<div class="row align-items-center">
										<div class="col-md-12">
											...
											<ul class="breadcrumb">
												...
												<li class="breadcrumb-item"><a href="#!">New User Company</a></li>
											</ul>
										</div>
									</div>
								</div>
                                ...
                                <div class="col-xl-12"><br><br>
                                    <div class="card">
                                        ...
                                        <div class="card-body table-border-style">
                                           ...
                                           <td><button class="bg-success"><a href="edit_company.php?id=<?php echo $row["id"]; ?>" style="color: white;">Edit</a></button></td>
                                           <td><button class="bg-danger"><a href="delete_company.php?id=<?php echo $row["id"] ?>" style="color: white;">Delete</a></button></td>
                                                        	</tr>
                                                    		<?php
                                                    	}
